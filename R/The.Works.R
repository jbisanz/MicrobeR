#' \code{The.Works} Takes a feature/OTU/SV table and calculates an extensive set of metrics for downstream use. A number of versions of the normalized data are available from the returned object. See below for more information. For extremely large tables (>500x1000) this function is not reccomended as it will make numerous copies and have a significant memory footprint.
#'
...
#' @usage AnalyedTable<-TheWorks(MicrobeR.Demo.SVtable,MicrobeR.Demo.Tree)
